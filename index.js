"use strict";
addEventListener('pointerdown', (pointerDownEvent) => {
    const separator = pointerDownEvent.target;
    ...
    let pane1 = separator.previousElementSibling;
    let pane2 = separator.nextElementSibling;
